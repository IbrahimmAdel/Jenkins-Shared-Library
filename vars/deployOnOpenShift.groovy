#!usr/bin/env groovy
def call(String imageName, deploymentFileName, String openshifProject, String openshiftCluster)//String imageName, String deploymentFileName, String openshiftCredentialsID, String openshiftServerURL, String openshifProject) {
